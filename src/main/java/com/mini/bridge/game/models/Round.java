...
public class Round {
    ...
    public List<RoundUser> getOrderedUserRounds() {
        List<RoundUser> orderedUsers = new ArrayList<>(getUserRounds());
        orderedUsers.sort(Comparator.comparing(RoundUser::getCurrentOrder));
        return orderedUsers;
    }
